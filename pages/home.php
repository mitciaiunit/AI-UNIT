  ...
  <div class="container">
    ...
    <div class="about-grid">
      ...
      <div class="about-right">
        <div class="card card-vision reveal">
        ...
        <div class="card card-objectives reveal">
          ...
          <div class="card-icon icon-gold"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div>
          <h3 data-i18n="objectives_title">Our Six Objectives</h3>
          <ul class="objectives-list" aria-label="Objectives list">
            <li data-i18n="obj1">Govern Trusted AI</li><li data-i18n="obj2">Modernize Public Services</li><li data-i18n="obj3">Grow the AI Ecosystem</li>
            <li data-i18n="obj4">Build Future-Ready Skills</li><li data-i18n="obj5">Strengthen Data Infrastructure</li><li data-i18n="obj6">Elevate Mauritius' Global Standing</li>
          </ul>
        </div>
      </div>
    </div>
...
<!-- AI IN ACTION -->
<section class="section action-section" id="action" aria-labelledby="action-title">
  <div class="container">
...
<!-- STRATEGY / LIBRARY -->
<section class="section library-section" id="strategy" aria-labelledby="strategy-title">
  <div class="container">
      ...
      <article class="doc-card reveal">
        ...
        <div class="doc-body">
          ...
          <div class="audio-player-inline" aria-live="polite">
            ...
            <div class="audio-progress-bar"><div class="audio-progress-fill"><span class="audio-progress-thumb"></span></div></div>
          </div>
        </div>
      </article>
...
<section class="principles-section" id="about-combined" aria-labelledby="about-combined-title">
  <div class="container">
      ...
      <form class="contact-form reveal" id="contactForm" novalidate aria-label="Contact form">
        ...
        <div class="form-group">
          ...
          <select id="subject" name="subject">
            ...
            <option data-i18n="form_topic3">Public Services Feedback</option>
            <option data-i18n="form_topic4">DIVA / Digital Services</option>
            <option data-i18n="form_topic5">AI Marketplace</option>
        ...
        <button type="submit" class="btn-primary btn-full">
          <span data-i18n="form_send">Send Message</span>
